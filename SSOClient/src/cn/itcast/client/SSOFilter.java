 ...
 * Function: 登录状态验证拦截器
 * @author   zhangtian
 * @Date	 2016	2016年2月27日		下午3:12:34
 */
public class SSOFilter implements Filter {
	...
	private boolean notLoginOnFail ;
	...
	public void doFilter(ServletRequest req, ServletResponse resp,
        ...
        if (vt != null) {
        	...
        	// 首先请求的时候由于__vt_param__参数为空 则vtPARASHIm获取值为空
        	// 则跳转到登陆，登陆携带回调url，登陆成功后在回调url中拼接__vt_param__参数
        	// 但本地vt依然不存在，则继续这一步，得到vtParam不为空，然后在调用自身谢cookie并重定向
        	// 最后再本地cookie拿到登陆信息的令牌，放心过滤器，执行其他操作
	...
	private void holdUser(SSOUser user, HttpServletRequest request) {
